...
global $language;
	...
	echo "<br>Money pool - $10 - via Paypal to vilnico@gmail.com, or in person, before the start of the tournament OR Google Wallet works too (if you live in the US)";
/*	switch($language) {
